...
<head>
	...
	<script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyBTrMqMkNVTpfUkZ1r_YqNRV1S1SWfTjXY&sensor=false"></script>

	<!-- Initialize Map and markers -->

	<script type="text/javascript">
		var myCenter=new google.maps.LatLng(35.706421,51.426771);
		var marker;
		var map;
		var mapProp;
